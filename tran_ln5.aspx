		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				try{
					...
					if(t_para.noa.length>0)
						q_content = "where=^^ noa='"+t_para.noa+"' and vccno='tran_ln5' ^^";
				}catch(e){
					q_content = "where=^^ vccno='tran_ln5'^^";
				}
			...
			function mainPost() {
				...
				$('#lblOrdeno').click(function() {
					...
					var t_edate = '';
                	var t_where ='';
                	q_box("tran_ln_b.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + t_where+";"+";"+JSON.stringify({bdate:t_bdate,edate:t_edate,page:'tran_ln5'}), "tran_ln", "95%", "95%", '');
				});
			}
                	...
                	case 'tran_ln':
                        if (b_ret != null) {
                        	...
                        	if(as[0].noa.length>0){
                        		...
                        		$('#txtV01').val(as[0].v01);//船隻編號
                        		$('#txtDatea').val(as[0].datea);//作業日期
                        		$('#txtCustno').val(as[0].custno);//客戶名稱
                        		$('#txtCust').val(as[0].cust);
                        		$('#txtPartno').val(as[0].partno);//貨主
                        		$('#txtPart').val(as[0].part);
                        		$('#txtV02').val(as[0].v02);//M.V.
                        		$('#txtV03').val(as[0].v03);//VOY NO.
                        		$('#txtV04').val(as[0].v04);//PORT.
                        		$('#txtBegindate').val(as[0].begindate);//ARRIVAL
                        		$('#txtV05').val(as[0].v05);//BERTHED
                        		$('#txtV06').val(as[0].v06);//WHARF NO
                        	}
                        	sum();
                        }else{
                        	Unlock(1);
			...
			function _btnSeek() {
				if (q_cur > 0 && q_cur < 4)
					return;
				q_box('tran_ln5_s.aspx', q_name + '_s', "500px", "600px", q_getMsg("popSeek"));
			}
			...
			function refreshBbs(){
				var t01=0,t02=0,t03=0,t04=0,t05=0,t06=0,t07=0
					,t08=0,t09=0,t10=0,t11=0,t12=0,t13=0,t14=0,t15=0,t16=0,t17=0,t18=0,t19=0;
		...
		<div id='dmain' >
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						<td><span> </span><a class="lbl btn" id="lblOrdeno">匯入資料</a></td>
						<td colspan="2"><input type="text" id="txtOrdeno" class="txt c1"/></td>
					</tr>
					<tr>
						<td><span> </span><a class="lbl" id="lblV01">船隻編號</a></td>
		...
		<div style="width: 2120px;">
			<table>
				<tr style='color:white; background:#003366;' > 				
					...
					<td align="center" colspan="1" rowspan="3" style="width:100px;display:none;"><a>車行</a></td>
		...
		<div style="width: 2120px;">
			<table>
				<tr style='color:white; background:#003366;' > 	
					...
					<td align="center" colspan="1" rowspan="1" style="width:50px;"> </td>
					<td align="center" colspan="1" rowspan="1" style="width:50px;"> </td>
					<td align="center" colspan="1" rowspan="1" style="width:100px;display:none;"> </td>
		...
		<div class='dbbs' style="width: 2120px;">
			<table id="tbbs" class='tbbs'>
				<tr style="color:white; background:#003366;display:none;" >
					...
					<td align="center" colspan="1" rowspan="1" style="width:50px;"><a> </a></td>
					<td align="center" colspan="1" rowspan="1" style="width:100px;display:none;"><a> </a></td>
